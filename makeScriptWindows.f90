...
Open(unit=10,file='generatedScript.bat')
Do i = start, end
...
write(10,'(a, I3.3, a)') "Xcopy /y Batch",i,"\Inputs\directionInputs.inp Inputs\"
...
write(10,*) ".\MCScattering_FM.exe"
write(10,*) "timeout /t 10"
write(10,*) ".\TimeSliceBinning.exe"
write(10,*) "timeout /t 10"
write(10,*) ".\StepSizeBinning.exe"
write(10,*) "timeout /t 10"
write(10,*) ".\Absorption.exe"
write(10,*) "timeout /t 10"
